...
The application is built entirely as a static client-side application. The core of its data layer is [words.json](file:///Users/tareqmy/development/javascriptprojects/kalimacards/assets/words.json), which acts as a read-only database. 

During runtime:
1. The client loads [index.html](file:///Users/tareqmy/development/javascriptprojects/kalimacards/index.html) and fetches [words.json](file:///Users/tareqmy/development/javascriptprojects/kalimacards/assets/words.json).
2. The user interface and filtering logic are managed dynamically in [app.js](file:///Users/tareqmy/development/javascriptprojects/kalimacards/lib/app.js).
...
The main dictionary file [words.json](file:///Users/tareqmy/development/javascriptprojects/kalimacards/assets/words.json) contains a sorted JSON list of lemma objects.
...
*   **[manifest.json](file:///Users/tareqmy/development/javascriptprojects/kalimacards/assets/manifest.json)**:
